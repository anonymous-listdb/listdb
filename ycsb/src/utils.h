...
#include "ycsb/core/properties.h"
...
void parse_command_line_arguments(int argc, char* argv[], utils::Properties* props, std::vector<char>* wl_chars) {
  ...
  struct option long_options[] = {
    ...
    { "mem_size", required_argument, 0, 0 },
    { "dram_limit", required_argument, 0, 0 },
    { "num_workers", required_argument, 0, 0 },
    { "periodic_compaction_mode", required_argument, 0, 0 },
    { "num_pmem_levels", required_argument, 0, 0 },
    // ycsb client options
    { "write_stats_to_file", required_argument, 0, 0 },
    { 0, 0, 0, 0 }
  };
